...
data segment
        val  dd 0fd21fd23h           ;要转换的二进制数
        flag db '-'
        buff db 10 dup(?),24h        ;给转换成的十进制数预留槽位
data ends
...
code segment
        ...
        ;其他说明:算法：把32位二进制数除以10余数为个位数的BCD码，商再除以10,余数为十位数的BCD码，循环5次
        ;=======================================
btoasc PROC far                                ;远过程
                push bp                        ;保存主程序栈基址
